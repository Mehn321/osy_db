...
switch ($target_group) {
    case 'All':
        $recipients = $allProfiles; $recipient_type_db = 'All'; break;
    case 'OSY':
        $recipients = array_values(array_filter($allProfiles, fn($p) => $p['profile_type'] === 'OSY'));
        $recipient_type_db = 'OSY'; break;
    case 'Non-OSY':
        $recipients = array_values(array_filter($allProfiles, fn($p) => $p['profile_type'] !== 'OSY'));
        $recipient_type_db = 'Non-OSY'; break;
    case 'Unemployed':
      ...
      <table width='600' cellpadding='0' cellspacing='0' style='max-width:600px;width:100%;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08)'>
        ...
        <tr>
          <td style='background:linear-gradient(135deg,#1e3a8a 0%,#1d4ed8 100%);padding:32px 40px'>
            <table width='100%' cellpadding='0' cellspacing='0'>
              <tr>
                <td>
                  <p style='margin:0 0 4px 0;font-size:11px;font-weight:700;letter-spacing:2px;color:#93c5fd;text-transform:uppercase'>Municipal KK</p>
        ...
        <tr>
          <td style='padding:36px 40px'>
            ...
            <p style='margin:0;font-size:13px;color:#6b7280'>If you have questions, please visit your local Municipal KK office or contact your assigned coordinator.</p>
          </td>
        </tr>
        ...
        <tr>
          <td style='background:#f8fafc;border-top:1px solid #e2e8f0;padding:24px 40px'>
            <p style='margin:0 0 4px 0;font-size:12px;color:#9ca3af;text-align:center'>This is an official notification from the Municipal KK Youth Registry System.</p>
            <p style='margin:0;font-size:12px;color:#9ca3af;text-align:center'>Please do not reply to this email. © {$year} Municipal KK</p>
          </td>
        </tr>
