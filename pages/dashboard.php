...
// --- Branch Logic by Role ---

if ($userRole === 'lydo'):
    // --- LYDO / ADMIN DASHBOARD (Existing View) ---
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
        <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 flex items-start justify-between">
            <div>
                ...
                <h3 class="text-4xl font-black text-blue-900 dark:text-blue-200"><?php echo $stats['total_kk']; ?></h3>
            ...
            <div class="p-3 bg-blue-100 dark:bg-blue-900/30 rounded-lg text-blue-900 dark:text-blue-200">
        ...
        <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 flex items-start justify-between">
            <div>
                ...
                <h3 class="text-4xl font-black text-blue-900 dark:text-blue-200"><?php echo $stats['total_opportunities']; ?></h3>
                <p class="text-xs text-slate-500 dark:text-slate-400 font-medium mt-2">Active training & jobs</p>
            </div>
            <div class="p-3 bg-green-100 dark:bg-green-900/30 rounded-lg text-green-900 dark:text-green-200">
        ...
        <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 flex items-start justify-between">
            <div>
                ...
                <h3 class="text-4xl font-black text-blue-900 dark:text-blue-200"><?php echo $stats['accepted_matches']; ?></h3>
                <p class="text-xs text-slate-500 dark:text-slate-400 font-medium mt-2 flex items-center gap-1">
                    <span class="material-symbols-outlined text-sm">check_circle</span> <?php echo $stats['pending_matches']; ?> pending
                </p>
            </div>
            <div class="p-3 bg-purple-100 dark:bg-purple-900/30 rounded-lg text-purple-900 dark:text-purple-200">
        ...
        <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 flex items-start justify-between">
            <div>
                ...
                <h3 class="text-4xl font-black text-blue-900 dark:text-blue-200"><?php echo $stats['total_notifications_sent']; ?></h3>
        ...
        <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 flex flex-col justify-between">
            <div class="flex items-start justify-between mb-3">
                <div>
                    ...
                    <h3 class="text-4xl font-black <?php echo $dashScoringPct >= 100 ? 'text-emerald-600' : ($dashScoringPct >= 50 ? 'text-amber-600' : 'text-blue-900 dark:text-blue-200'); ?>"><?php echo $dashScoringPct; ?>%</h3>
                </div>
                <div class="p-3 bg-indigo-100 dark:bg-indigo-900/30 rounded-lg text-indigo-700 dark:text-indigo-200">
...
?>
    <!-- Welcome Header -->
    <div class="mb-10">
        <h2 class="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight mb-2">Barangay <?php echo htmlspecialchars($userBarangay); ?> Dashboard</h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 flex items-start justify-between">
            <div>
                <p class="text-sm font-semibold text-slate-600 dark:text-slate-400 uppercase tracking-wider mb-1">Registered Youth</p>
                <h3 class="text-4xl font-black text-blue-900 dark:text-blue-200"><?php echo $skStats['total_kk']; ?></h3>
                <p class="text-xs text-slate-500 dark:text-slate-400 font-medium mt-2">Total registered in <?php echo htmlspecialchars($userBarangay); ?></p>
            </div>
            <div class="p-3 bg-blue-100 dark:bg-blue-900/30 rounded-lg text-blue-900 dark:text-blue-200">
                <span class="material-symbols-outlined text-3xl">groups</span>
            </div>
        ...
        <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 flex items-start justify-between border-l-4 border-l-orange-500">
            <div>
                <p class="text-sm font-semibold text-slate-600 dark:text-slate-400 uppercase tracking-wider mb-1">Awaiting Verification</p>
                <h3 class="text-4xl font-black text-orange-600"><?php echo $skStats['pending_verification']; ?></h3>
                <p class="text-xs text-slate-500 dark:text-slate-400 font-medium mt-2">Needs your review</p>
                <a href="verify-youth.php" class="inline-flex items-center text-xs font-bold text-orange-600 hover:underline mt-2">Verify Now <span class="material-symbols-outlined text-xs">arrow_forward</span></a>
            </div>
            <div class="p-3 bg-orange-100 dark:bg-orange-900/30 rounded-lg text-orange-600">
        ...
        <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 flex items-start justify-between">
            <div>
                <p class="text-sm font-semibold text-slate-600 dark:text-slate-400 uppercase tracking-wider mb-1">Verified Members</p>
                <h3 class="text-4xl font-black text-green-600"><?php echo $skStats['verified_youth']; ?></h3>
                <p class="text-xs text-slate-500 dark:text-slate-400 font-medium mt-2">Ready for opportunities</p>
            </div>
    ...
    <!-- Recent Registrations in Barangay -->
    <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
        <div class="p-6 border-b border-slate-200 dark:border-slate-700 flex justify-between items-center">
            <h4 class="text-lg font-bold text-slate-900 dark:text-white">Recent Submissions (<?php echo htmlspecialchars($userBarangay); ?>)</h4>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-slate-200 dark:divide-slate-700">
                    <?php if (!empty($recentBarangay)): ?>
                        <?php foreach ($recentBarangay as $reg): ?>
                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                                <td class="px-6 py-4">
                                    <p class="font-bold text-slate-900 dark:text-white"><?php echo htmlspecialchars($reg['first_name'] . ' ' . $reg['last_name']); ?></p>
                                    <p class="text-xs text-slate-500 dark:text-slate-400"><?php echo date('M d, Y', strtotime($reg['created_at'])); ?></p>
                                </td>
                                <td class="px-6 py-4 text-sm text-slate-700 dark:text-slate-300"><?php echo htmlspecialchars($reg['primary_skill'] ?? 'N/A'); ?></td>
                                <td class="px-6 py-4">
                                    <span class="inline-flex px-3 py-1 rounded-full text-xs font-bold <?php
                                ...
                                <td class="px-6 py-4">
                                    <a href="profile-detail.php?id=<?php echo $reg['id']; ?>" class="text-blue-900 dark:text-blue-400 hover:underline text-sm font-bold flex items-center gap-1">
                                        View Profile <span class="material-symbols-outlined text-xs">visibility</span>
                                    </a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr>
                            <td colspan="4" class="px-6 py-12 text-center text-slate-500">No youth registered in your barangay yet.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
...
?>
    ...
    <div class="mb-10">
        ...
        <p class="text-slate-600 dark:text-slate-400 font-medium">Manage your posted <?php echo $isEmployer ? 'job openings' : 'training programs'; ?> and review applications.</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
        <div class="bg-white dark:bg-slate-800 p-8 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 flex items-start justify-between">
            <div>
                ...
                <h3 class="text-4xl font-black text-blue-900 dark:text-blue-200"><?php echo $providerStats['total_posted']; ?></h3>
                <p class="text-xs text-slate-500 dark:text-slate-400 font-medium mt-2">Active and closed opportunities</p>
                <a href="<?php echo $isEmployer ? 'my-job-openings.php' : 'my-training-programs.php'; ?>" class="inline-flex items-center text-xs font-bold text-blue-900 dark:text-blue-400 hover:underline mt-4">Manage Postings <span class="material-symbols-outlined text-xs">arrow_forward</span></a>
            </div>
            <div class="p-3 bg-blue-100 dark:bg-blue-900/30 rounded-lg text-blue-900 dark:text-blue-200">
                <span class="material-symbols-outlined text-3xl"><?php echo $isEmployer ? 'work' : 'school'; ?></span>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-slate-800 p-8 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 flex items-start justify-between">
            <div>
                ...
                <h3 class="text-4xl font-black text-purple-600"><?php echo $providerStats['total_applications']; ?></h3>
                <p class="text-xs text-slate-500 dark:text-slate-400 font-medium mt-2">Received through the platform</p>
            </div>
                ...
                <tbody class="divide-y divide-slate-200 dark:divide-slate-700">
                    <?php if (!empty($recentOpp)): ?>
                        ...
                        ?>
                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                                <td class="px-6 py-4">
                                    <p class="font-bold text-slate-900 dark:text-white"><?php echo htmlspecialchars($opp['title']); ?></p>
                                    <p class="text-xs text-slate-500 dark:text-slate-400"><?php echo htmlspecialchars($opp['type']); ?></p>
                                </td>
                                <td class="px-6 py-4 text-sm text-slate-700 dark:text-slate-300"><?php echo $opp['deadline'] ? date('M d, Y', strtotime($opp['deadline'])) : 'N/A'; ?></td>
                                <td class="px-6 py-4">
                                    <span class="inline-flex px-3 py-1 rounded-full text-xs font-bold <?php echo $opp['status'] === 'Open' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'; ?>">
                                        <?php echo htmlspecialchars($opp['status']); ?>
                                    </span>
                                </td>
                                <td class="px-6 py-4 text-sm font-bold text-blue-900 dark:text-blue-400"><?php echo $appCount; ?> Applicants</td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr>
                            <td colspan="4" class="px-6 py-12 text-center text-slate-500">You haven't posted any opportunities yet.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
