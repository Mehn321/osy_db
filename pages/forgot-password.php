    ...
    if (!consumeFormNonce($_POST['form_nonce'] ?? '')) {
        ...
        if ($step === 'request') {
            ...
            if (isset($_POST['resend'])) {
                $result = $user->resendPasswordResetOtp();
                if ($result['success']) {
...
<body
    class="bg-slate-50 text-slate-900 min-h-screen flex flex-col justify-center items-center px-4 relative overflow-hidden">
